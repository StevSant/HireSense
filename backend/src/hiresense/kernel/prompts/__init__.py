...
from hiresense.kernel.prompts.fingerprint import prompt_fingerprint
from hiresense.kernel.prompts.match_gating_rules import (
    BATCH_SCORING_CONSEQUENCES,
    DEEP_ANALYSIS_CONSEQUENCES,
    GatingConsequences,
    render_gating_rules,
)
from hiresense.kernel.prompts.verdict_bands import (
    MODERATE_THRESHOLD,
    STRONG,
    STRONG_THRESHOLD,
    MODERATE,
