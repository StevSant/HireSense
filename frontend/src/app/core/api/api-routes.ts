...
export const API_ROUTES = {
  ...
  applications: {
    ...
    packet: defineRoute('/applications/:id/packet'),
    packetExport: defineRoute('/applications/:id/packet/export'),
    packetRestore: defineRoute('/applications/:id/packet/restore'),
    packetApprove: defineRoute('/applications/:id/packet/:packetId/approve'),
    packetRevoke: defineRoute('/applications/:id/packet/:packetId/revoke'),
    quality: defineRoute('/applications/:id/quality'),
